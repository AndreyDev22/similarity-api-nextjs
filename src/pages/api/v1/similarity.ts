...
import { withMethods } from '@/lib/api-middleweares/with-methods';
...
const habdler = async (req: NextApiRequest, res: NextApiResponse) => {
...
export default withMethods(['POST'], habdler);
